 ...
 * @return {?}
 */
function getElementRect(element, ghostElementPositioning, scaledParent, scale = 1.0) {
    ...
    if (ghostElementPositioning === 'absolute') {
        ...
        const /** @type {?} */ boundingClientRect = element.nativeElement.getBoundingClientRect();
        let /** @type {?} */ boundingRect;
        if (scale !== 1.0) {
            if (scaledParent) {
                const /** @type {?} */ parentClientRect = scaledParent.getBoundingClientRect();
                boundingRect = {
...
function getEdgesDiff({ edges, initialRectangle, newRectangle }) {
    ...
    Object.keys(edges).forEach((edge) => {
        const /** @type {?} */ typedEdge = /** @type {?} */ (edge);
        edgesDiff[typedEdge] =
...
class ResizableDirective {
    ...
    ngOnInit() {
        ...
        this.mousedown
            ...
            const /** @type {?} */ startingRect = getElementRect(this.elm, this.ghostElementPositioning, this.scaledParent, this.scale);
            currentResize = {
                edges,
                startingRect,
