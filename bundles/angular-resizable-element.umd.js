 ...
 * @return {?}
 */
function getElementRect(element, ghostElementPositioning, scaledParent, scale) {
    ...
    if (ghostElementPositioning === 'absolute') {
        ...
        var /** @type {?} */ boundingClientRect = element.nativeElement.getBoundingClientRect();
        var /** @type {?} */ boundingRect = void 0;
        if (scale !== 1.0) {
            if (scaledParent) {
                var /** @type {?} */ parentClientRect = scaledParent.getBoundingClientRect();
                boundingRect = {
...
var ResizableDirective = /** @class */ (function () {
    ...
    ResizableDirective.prototype.ngOnInit = function () {
        ...
        this.mousedown
            ...
            var /** @type {?} */ startingRect = getElementRect(_this.elm, _this.ghostElementPositioning, _this.scaledParent, _this.scale);
            currentResize = {
                edges: edges,
